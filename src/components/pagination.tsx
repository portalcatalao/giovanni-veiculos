...
import { components } from '@/utils/tailwind';
    ...
    <nav className="flex items-center justify-center gap-2 my-4">
      {!isFirstPage && (
        <button
          ...
          className={'w-8 h-8 flex items-center justify-center rounded-md bg-primary-500 text-white hover:bg-primary-600 transition-colors'}
        >
          <FiChevronLeft />
        </button>
      )}
