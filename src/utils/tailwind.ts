export const components = {
    ...
    button: {
        ...
        primary: 'flex items-center justify-center gap-3 bg-primary-500 text-white h-12 px-4 rounded-md shadow-md font-medium text-base hover:bg-primary-600 transition-colors',
        ...
        secondary: 'cursor-pointer font-medium px-6 h-10 flex items-center justify-center rounded-md bg-zinc-200 text-zinc-600 text-sm hover:bg-zinc-300 transition-colors',
